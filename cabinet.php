    ...
    <div class="header__container container">
        ...
        <div class="header__background-user">
            ...
            <div class="header__background-user">
                <?php else: ?>
                <div class="header__background-user"
                     style='background: url("backgrounds/<?php echo $_SESSION['user']['background'] . '?' . time(); ?>") no-repeat; background-size: cover;background-position:center;'>
                    <?php endif; ?>
                    ...
                    <div class="header__flex">
                        ...
                        <div class="header__account-grad">
                            ...
                            <?php endif; ?>
                            <?php if (!empty($_SESSION['user']['photo'])): ?>
                            <div class="header__account-grad-photo">
                                <div class="header__account"
                                     style='background: url("avatars/<?php echo $_SESSION['user']['photo']; ?>") no-repeat; background-size: 100% 100%'
                                     id="header__account">
                                </div>
                                <?php endif; ?>
...
<main class="main">
    ...
    <div class="information-from-user">
        <div class="information-from-user__container container">
            <p class="information-from-user__absent">Информация отсутствует</p>
        </div>
    </div>
</main>
